<?php
    ...
    $scriptSQLMeal = "SELECT meal.id_meal, meal.name, meal.description, meal.src_photo, meal.enable FROM meal, category WHERE meal.id_category = category.id_category && category.name = 'Acompanhamentos'";
